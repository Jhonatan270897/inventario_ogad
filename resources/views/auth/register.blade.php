@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('Inventario')])
                    ...
                    <div class="card-body ">
                        ...
                        <div class="bmd-form-group{{ $errors->has('username') ? ' has-danger' : '' }} mt-3">
                            <div class="input-group">
                                ...
                                <input type="text" name="username" class="form-control" placeholder="{{ __('DNI...') }}" value="{{ old('username') }}" required autocomplete="username">
                            </div>
                        ...
                        <div class="bmd-form-group{{ $errors->has('password_confirmation') ? ' has-danger' : '' }} mt-3">
                            <div class="input-group">
                                ...
                                <input type="password" name="password_confirmation" id="password_confirmation" class="form-control" placeholder="{{ __('Confirmar Password...') }}" required autocomplete="new-password">
                            </div>
