      ...
      <div class="col-md-12">
        <form action="{{ route('users.store') }}" method="post" class="form-horizontal">
          ...
          <div class="card">
            ...
            <div class="row">
              <label for="username" class="col-sm-2 col-form-label">DNI</label>
              <div class="col-sm-7">
                <input type="text" class="form-control" name="username" placeholder="Ingrese su DNI" value="{{ old('username') }}">
