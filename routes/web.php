...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/almacen_marca', 'App\Http\Controllers\AlmacenController@marca')->name('almacen.marca');
    Route::get('/almacen_categoria', 'App\Http\Controllers\AlmacenController@categoria')->name('almacen.categoria');
    Route::get('/almacen_stock', 'App\Http\Controllers\AlmacenController@stock')->name('almacen.stock');
    Route::get('/almacen_entrada', 'App\Http\Controllers\AlmacenController@entrada')->name('almacen.entrada');
    Route::get('/almacen_salida', 'App\Http\Controllers\AlmacenController@salida')->name('almacen.salida');
    Route::get('/almacen_detalle_producto', 'App\Http\Controllers\AlmacenController@detalle_producto')->name('almacen.producto');
